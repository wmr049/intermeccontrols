...
namespace Hasci.TestApp.IntermecPhotoControls
{
    /// <summary>
    ...
    public partial class IntermecCameraControl : UserControl,Hasci.TestApp.DeviceControlContracts.IPhotoControl
    {
        /// <summary>
